...
function Feed() {
  ...
  return (
    <div className='lg:w-[50%] w-full min-h-[100vh] lg:h-[100vh] relative lg:overflow-y-auto'>
        <div className='w-full h-[100px] flex items-center justify-between p-[20px] lg:hidden'>
              <img src={logo} alt="" className='w-[80px]'/>
              <div className='flex items-center gap-[10px]'>
            <img src={aiIcon} alt="AI" className='w-[25px] h-[25px] cursor-pointer' onClick={()=>navigate('/ai-features')}/>
...
<div className='w-full min-h-[100vh] flex flex-col items-center gap-[20px] p-[10px] pt-[24px] glass-card rounded-t-[24px] relative pb-[120px]'>
